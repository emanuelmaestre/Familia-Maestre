...
DECLARE
  ...
  new_id TEXT;
BEGIN
  SELECT id INTO old_id FROM "transaction_categories" WHERE "name" = 'AlimentaÃ§Ã£o' LIMIT 1;
  ...
  SELECT id INTO old_id FROM "transaction_categories" WHERE "name" = 'SaÃºde' LIMIT 1;
  ...
  SELECT id INTO old_id FROM "transaction_categories" WHERE "name" = 'EducaÃ§Ã£o' LIMIT 1;
  ...
  SELECT id INTO old_id FROM "transaction_categories" WHERE "name" = 'SalÃ¡rio' LIMIT 1;
